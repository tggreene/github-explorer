...
var len__20172__auto___27027 = arguments.length;
var i__20173__auto___27028 = (0);
while(true){
if((i__20173__auto___27028 < len__20172__auto___27027)){
args__20179__auto__.push((arguments[i__20173__auto___27028]));

var G__27029 = (i__20173__auto___27028 + (1));
i__20173__auto___27028 = G__27029;
continue;
} else {
}
break;
...
ghe.github.get_api.cljs$lang$applyTo = (function (seq27025){
var G__27026 = cljs.core.first.call(null,seq27025);
var seq27025__$1 = cljs.core.next.call(null,seq27025);
return ghe.github.get_api.cljs$core$IFn$_invoke$arity$variadic(G__27026,seq27025__$1);
});
ghe.github.get_repo = (function ghe$github$get_repo(page,owner,repo,handler){
var url = [cljs.core.str(ghe.github.api),cljs.core.str("/repos/"),cljs.core.str(owner),cljs.core.str("/"),cljs.core.str(repo),cljs.core.str("/events")].join('');
